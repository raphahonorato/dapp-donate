...
export default function Donate() {
    ...
    function btnDonateClick() {
        ...
        donate(campaign.id, donation)
            .then(tx => setMessage(` Doação realizada com sucesso, em alguns instantaes o saldo será atualizados! `))
            .catch(err => setMessage(err.message))
    }
                ...
                <h1 className='display-5 fw-bold text-body-emphasis lh-1 mb-3'>Donate Crypto</h1>
                {
                    !campaign.id
                        ? (
                            <>
                                <p className="mb-5">
                                    Insira o ID da campanha que procura:
                                </p>
                                <div className="col-3">
                        ...
                        : (
                            <>
                                <p>Verifique se esta é a campanha certa antes de realizar a doação!</p>
                                <hr />
                                <div className="row flex-lg-row-reverse align-items-center g-5">
                                    ...
                                    <div className="col-5 mb-5" style={{ height: 480, scrollbars: true }}>
                                        ...
                                        {
                                            campaign.videoUrl
                                                ? <p>Assista o video ao lado</p>
                                                : <></>
                                        }
                                        <p className="mb-3 fsl-italic mt-5">
                                            Já foram arrecadados {campaign.balance / 10 ** 18} BNB nesta campanha!
                                            O quanto você quer doar?
                                        </p>
                                        <div className="mb-3">
